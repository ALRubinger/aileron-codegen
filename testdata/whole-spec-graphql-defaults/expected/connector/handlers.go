...
const thingCreateMutation = `mutation ThingCreate($name: String!) {
  thingCreate(name: $name) {
    id
    name
  }
}`

func handleThingCreate(args map[string]any, transport Transport) (map[string]any, error) {
	...
	return graphqlCall(transport, thingCreateMutation, variables)
}
