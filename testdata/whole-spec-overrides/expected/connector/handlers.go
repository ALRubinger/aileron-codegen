...
const issueMarkAsReadMutation = `mutation IssueMarkAsRead($id: String!) {
  issueMarkAsRead(id: $id)
}`

func handleIssueMarkAsRead(args map[string]any, transport Transport) (map[string]any, error) {
	...
	return graphqlCall(transport, issueMarkAsReadMutation, variables)
}
...
func handleTeams(args map[string]any, transport Transport) (map[string]any, error) {
	return graphqlCall(transport, teamsQuery, nil)
}
